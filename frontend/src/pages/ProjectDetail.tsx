      ...
      <div className="flex items-center gap-3 flex-wrap mb-8">
        {project.hasSlide && (
          <a
            ...
            className="inline-flex items-center px-3 py-1.5 text-sm font-sans font-medium text-[#F5F0EB] bg-surface border border-border hover:bg-ink-50 transition-colors rounded"
          >
