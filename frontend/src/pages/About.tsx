    ...
    <PageLayout>
      ...
      <div className="prose prose-slate max-w-none">
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Qui sommes-nous</h2>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Données publiques</h3>
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Méthodologie rigoureuse</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Transparence</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Indépendance</h3>
              <p className="text-gray-600 text-sm">
